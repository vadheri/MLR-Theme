...
if(get_sub_field('section_enabledisable') == 'enable'){
    ...
    ?>
    <section class="section banner <?php echo $section_spacing; ?> hello">
        <div class="container">
            <div class="main-banner d-flex j-between">
                <div class="col-7">
                    ...
                    if ($custom_query->have_posts() || get_sub_field('select_post')) :
                    ?>
                    <div class="news-slider">
                            ...
                            ?>
                                    <div class="post-slide">
                                        <div class="post-thumbnail" style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url($post->ID, 'full') ?: get_template_directory_uri() . '/images/dummy-image.png'); ?>');"></div>
